...
// MARK: - DTO fixtures (re-decoded from JSONFixtures for brevity)
// @MainActor because the DTOs in this project are isolated to main-actor.
...
final class MockSearchRepository: SearchRepositoryProtocol {
    var searchResult: Result<SearchResultDTO, Error> = .failure(TestError())
